...
export default function ChatPanel() {
  ...
  // 📡 ACTIVE STREAM TRACKING STATE: Hooks up directly to the background web worker
  ...
  const bootLocalEngine = async () => {
    try {
      ...
      // Invoke your modern cloud-backed WebGPU loading anchor with dynamic callback loops
      await bootCipherEngine((progressValue) => {
