...
// ==========================================
// 1. ENGINE COLD BOOT (Loads weights directly from HF Cloud)
// ==========================================
export async function bootCipherEngine() {
    ...
    try {
        // FIX: Point the main URL directly to the Hugging Face repository file path
        // This ensures the architecture map and the weights are perfectly unified
