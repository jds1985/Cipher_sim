  ...
  try {
    ...
    if (typeof window !== "undefined" && !window.transformersModule) {
      await new Promise((resolve, reject) => {
        ...
        script.type = "module";
        // Inline code import ensures the module loads directly into a tracked window variable
        script.textContent = `
    ...
    // Capture the pipeline method from our manual module container bridge
