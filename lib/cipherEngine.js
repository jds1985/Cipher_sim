...
function getGlobalOrt() {
    if (typeof window !== 'undefined' && window.ort) {
        ...
        globalOrt.env.wasm.proxy = true; // Isolate thread execution
        return globalOrt;
    }
    return null;
}
...
export async function bootCipherEngine() {
    ...
    try {
        ...
        // This tells the low-level engine to intercept internal weights file lookups and route them to these URLs
