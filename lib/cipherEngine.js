...
// Force the engine to use the clean, all-in-one browser distribution file
import * as ort from 'onnxruntime-web/dist/ort.all.min.js';
...
export async function bootCipherEngine() {
    ...
    // Safe browser verification guard rails
