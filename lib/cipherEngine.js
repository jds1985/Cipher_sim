...
// ==========================================
// 1. ENGINE COLD BOOT (Self-Resolving Path Matrix)
// ==========================================
export async function bootCipherEngine() {
    ...
    try {
        // We drop the explicit 'externalWeightsUrl' configuration property
        // This lets the ONNX runtime natively read the model's inner metadata pointers 
        // and resolve its companion weights stream directly from the exact same HF folder location.
