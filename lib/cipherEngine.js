...
// Fetch helper with direct chunk-by-chunk download telemetry stream reporting
...
export async function bootCipherEngine({ onProgress = () => {} } = {}) {
    ...
    try {
        ...
        // FIXED: Passing the externalBuffers array containing separate shard variables natively to bypass memory limits
